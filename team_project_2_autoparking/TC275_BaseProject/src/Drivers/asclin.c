...
//	InterruptInstall(SRC_ID_ASCLIN0RX, (void(*)(int))IsrUart0RxHandler_ble, 1, 0);
//	MODULE_ASCLIN0.FLAGSENABLE.U = (1 << 28); /* FLAGSENABLE.RFLE */
}

unsigned char _in_uart0()
{
	unsigned char ch;
	/* wait for a new character */
