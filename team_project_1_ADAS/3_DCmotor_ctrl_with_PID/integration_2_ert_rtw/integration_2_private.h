...
#ifndef RTW_HEADER_integration_2_private_h_
#define RTW_HEADER_integration_2_private_h_
#include "rtwtypes.h"
...
extern void integration__IfActionSubsystem1(real_T *rty_Out1,
  P_IfActionSubsystem1_integrat_T *localP);
extern void integratio_IfActionSubsystem1_l(RT_MODEL_integration_2_T * const
  integration_2_M, real_T *rty_Out1, real_T *rty_Out2,
  P_IfActionSubsystem1_integr_d_T *localP);
extern void integration_2_IfActionSubsystem(real_T rtu_In1, real_T *rty_Out1,
  real_T *rty_Out2);

/* private model entry point functions */
extern void integration_2_derivatives(void);

#endif                                 /* RTW_HEADER_integration_2_private_h_ */
