...
#ifndef RTW_HEADER_integration_2_types_h_
#define RTW_HEADER_integration_2_types_h_
#include "MW_SVD.h"
#include "rtwtypes.h"
...
#ifndef typedef_codertarget_arduinobase_in_e1_T
#define typedef_codertarget_arduinobase_in_e1_T

typedef struct tag_hiATgaifu8RfrjZ2yifYbH codertarget_arduinobase_in_e1_T;

#endif                             /* typedef_codertarget_arduinobase_in_e1_T */
...
#ifndef typedef_codertarget_arduinobase_i_e1m_T
#define typedef_codertarget_arduinobase_i_e1m_T

typedef struct tag_jShWpKUOycwBMhFyiKcKhC codertarget_arduinobase_i_e1m_T;

#endif                             /* typedef_codertarget_arduinobase_i_e1m_T */

/* Parameters for system: '<S4>/If Action Subsystem1' */
typedef struct P_IfActionSubsystem1_integrat_T_ P_IfActionSubsystem1_integrat_T;

/* Parameters for system: '<S21>/If Action Subsystem1' */
typedef struct P_IfActionSubsystem1_integr_d_T_ P_IfActionSubsystem1_integr_d_T;

/* Parameters (default storage) */
typedef struct P_integration_2_T_ P_integration_2_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_integration_2_T RT_MODEL_integration_2_T;

#endif                                 /* RTW_HEADER_integration_2_types_h_ */
