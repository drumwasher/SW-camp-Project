...
typedef struct {
  ...
  real_T DataTypeConversion_n;         /* '<Root>/Data Type Conversion' */
...
typedef struct {
  ...
  codertarget_arduinobase_i_p4k_T obj_g;/* '<Root>/후방 초음파' */
  codertarget_arduinobase_i_p4k_T obj_h;/* '<Root>/좌측 초음파' */
  codertarget_arduinobase_i_p4k_T obj_p;/* '<Root>/전방 초음파' */
  codertarget_arduinobase_i_p4k_T obj_hy;/* '<Root>/우측 초음파' */
  struct {
    void *LoggedData;
...
extern void pr2_US_hap_SetEventsForThisBaseStep(boolean_T *eventFlags);

/* Model entry point functions */
extern void pr2_US_hap_initialize(void);
extern void pr2_US_hap_step0(void);
extern void pr2_US_hap_step2(void);
 ...
 * Block '<S6>/Derivative1' : Unused code path elimination
 ...
 * '<S6>'   : 'pr2_US_hap/Subsystem6'
 * '<S7>'   : 'pr2_US_hap/Subsystem/Chart'
 * '<S8>'   : 'pr2_US_hap/Subsystem/Chart1'
 * '<S9>'   : 'pr2_US_hap/Subsystem3/Discrete Derivative'
 */
