 ...
 *
 * File: Final_integration_1_types.h
 *
...
#ifndef RTW_HEADER_Final_integration_1_types_h_
#define RTW_HEADER_Final_integration_1_types_h_
#include "rtwtypes.h"
#include "MW_SVD.h"
...
#ifndef typedef_codertarget_arduinobase_blo_n_T
#define typedef_codertarget_arduinobase_blo_n_T

typedef struct tag_AYWgtFscQm3mLUJYb3A20C codertarget_arduinobase_blo_n_T;

#endif                             /* typedef_codertarget_arduinobase_blo_n_T */

/* Custom Type definition for MATLABSystem: '<Root>/조도센서 Input' */
#include "MW_SVD.h"
...
typedef struct tag_8ohiN1FAOgR98njPNu14NC codertarget_arduinobase_int_n_T;

#endif                             /* typedef_codertarget_arduinobase_int_n_T */

/* Parameters for system: '<S8>/If Action Subsystem1' */
typedef struct P_IfActionSubsystem1_Final_in_T_ P_IfActionSubsystem1_Final_in_T;

/* Parameters (default storage) */
typedef struct P_Final_integration_1_T_ P_Final_integration_1_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_Final_integration_1_T RT_MODEL_Final_integration_1_T;

#endif                             /* RTW_HEADER_Final_integration_1_types_h_ */
