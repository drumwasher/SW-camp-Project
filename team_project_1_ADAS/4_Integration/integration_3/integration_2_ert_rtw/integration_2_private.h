...
extern void integrat_IfActionSubsystem1(real_T *rty_Out1,
  P_IfActionSubsystem1_integrat_T *localP);
extern void integrat_IfActionSubsystem3(real_T *rty_Out1, real_T *rty_Out2,
  P_IfActionSubsystem3_integrat_T *localP);
extern void integrati_IfActionSubsystem(real_T rtu_In1, real_T *rty_Out1, real_T
  *rty_Out2);
