...
void ex2_encoder_step(void)
{
...

  {
    ...
    {
      ex2_encoder_DW.obj_j.SampleTime = ex2_encoder_P.AnalogInput_SampleTime;
    }

    ex2_encoder_DW.obj_j.AnalogInDriverObj.MW_ANALOGIN_HANDLE =
    ...
    if (rtmIsMajorTimeStep(ex2_encoder_M)) {
      ...
      /* DiscreteTransferFcn: '<S1>/Discrete Transfer Fcn' */
      tmp_0 = (uint32_T)ex2_encoder_P.num_Gd[1L];
      tmp_1 = (uint32_T)ex2_encoder_DW.DiscreteTransferFcn_states;
    ...
    if (rtmIsMajorTimeStep(ex2_encoder_M)) {
       ...
       *  Store in Global RAM
       */
      tmp_0 = (uint32_T)ex2_encoder_P.encoder_scale;
      ...
      sMultiWordMul(&ex2_encoder_P.Gain2_Gain.chunks[0U], 2,
                    &ex2_encoder_B.Gain1.chunks[0U], 2,
                    &ex2_encoder_B.Gain2.chunks[0U], 4);

      /* DataTypeConversion: '<S1>/Data Type Conversion1' incorporates:
       *  Gain: '<S1>/Gain1'
       */
      sMultiWordMul(&ex2_encoder_B.Gain1.chunks[0U], 2, &tmp_3.chunks[0U], 2,
                    &ex2_encoder_B.r2.chunks[0U], 4);
      sMultiWordShr(&ex2_encoder_B.r2.chunks[0U], 4, 31U,
    ...
    if (rtmIsMajorTimeStep(ex2_encoder_M)) {
      ...
      if (ex2_encoder_P.den_Gd[0] == 0L) {
        ...
        sMultiWord2MultiWord(&denAccum_0.chunks[0U], 2,
                             &ex2_encoder_B.r4.chunks[0U], 3);
        sMultiWordShl(&ex2_encoder_B.r4.chunks[0U], 3, 30U,
                      &ex2_encoder_B.r3.chunks[0U], 3);
        sLong2MultiWord(ex2_encoder_P.den_Gd[0], &ex2_encoder_B.r4.chunks[0U], 3);
        sMultiWordDivFloor(&ex2_encoder_B.r3.chunks[0U], 3,
                           &ex2_encoder_B.r4.chunks[0U], 3,
                           &ex2_encoder_B.r.chunks[0U], 4,
                           &ex2_encoder_B.r5.chunks[0U], 3,
                           &ex2_encoder_B.r6.chunks[0U], 3,
                           &ex2_encoder_B.r7.chunks[0U], 3);
        sMultiWord2MultiWord(&ex2_encoder_B.r.chunks[0U], 4, &tmp.chunks[0U], 2);
      }

      sMultiWordShr(&tmp.chunks[0U], 2, 30U, &tmp_3.chunks[0U], 2);
      ex2_encoder_DW.DiscreteTransferFcn_states = MultiWord2sLong(&tmp_3.chunks
        [0U]);
...
void ex2_encoder_initialize(void)
{
  ...
  ex2_encoder_DW.obj_j.matlabCodegenIsDeleted = false;
  ex2_encoder_DW.obj_j.SampleTime = ex2_encoder_P.AnalogInput_SampleTime;
  ex2_encoder_DW.obj_j.isInitialized = 1L;
  ex2_encoder_DW.obj_j.AnalogInDriverObj.MW_ANALOGIN_HANDLE =
    MW_AnalogInSingle_Open(62UL);
  ex2_encoder_DW.obj_j.isSetupComplete = true;
...
void ex2_encoder_terminate(void)
{
  ...
  if (!ex2_encoder_DW.obj_j.matlabCodegenIsDeleted) {
    ex2_encoder_DW.obj_j.matlabCodegenIsDeleted = true;
    if ((ex2_encoder_DW.obj_j.isInitialized == 1L) &&
        ex2_encoder_DW.obj_j.isSetupComplete) {
      ex2_encoder_DW.obj_j.AnalogInDriverObj.MW_ANALOGIN_HANDLE =
        MW_AnalogIn_GetHandle(62UL);
      MW_AnalogIn_Close
        (ex2_encoder_DW.obj_j.AnalogInDriverObj.MW_ANALOGIN_HANDLE);
