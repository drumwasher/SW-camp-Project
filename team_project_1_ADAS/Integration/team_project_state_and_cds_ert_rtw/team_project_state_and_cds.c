...
void team_project_state_and_cds_SetEventsForThisBaseStep(boolean_T *eventFlags)
{
  ...
  eventFlags[3] = ((boolean_T)rtmStepTask(team_project_state_and_cds_M, 3));
}
...
static void rate_monotonic_scheduler(void)
{
  ...
  if (team_project_state_and_cds_M->Timing.TaskCounters.TID[1] == 0) {
    team_project_state_and_cds_M->Timing.RateInteraction.TID1_3 =
      (team_project_state_and_cds_M->Timing.TaskCounters.TID[3] == 0);
  }
  ...
  (team_project_state_and_cds_M->Timing.TaskCounters.TID[3])++;
  if ((team_project_state_and_cds_M->Timing.TaskCounters.TID[3]) > 19) {/* Sample time: [0.2s, 0.0s] */
    team_project_state_and_cds_M->Timing.TaskCounters.TID[3] = 0;
  }
}
...
void team_project_state_and_cds_step0(void) /* Sample time: [0.0s, 0.0s] */
{
...

  {
    ...
    if (rtmIsMajorTimeStep(team_project_state_and_cds_M)) {
      ...
      if (team_project_state_and_cds_M->Timing.RateInteraction.TID1_3) {
        /* RateTransition generated from: '<S11>/If Action Subsystem1' */
        team_project_state_and_cds_B.TmpRTBAtIfActionSubsystem1Outpo =
          team_project_state_and_cds_DW.TmpRTBAtIfActionSubsystem1Outpo;
      }
    ...
    if (rtmIsMajorTimeStep(team_project_state_and_cds_M)) {
      ...
      team_project_state_and_cds_B.Constant = team_project_state_and_cds_P.f;

      /* Constant: '<Root>/Constant3' */
      team_project_state_and_cds_B.Constant3 = team_project_state_and_cds_P.l;

      /* Constant: '<Root>/Constant1' */
      team_project_state_and_cds_B.Constant1 = team_project_state_and_cds_P.r;
    }
    ...
    if (rtmIsMajorTimeStep(team_project_state_and_cds_M)) {
      ...
      team_project_state_and_cds_B.Constant2 = team_project_state_and_cds_P.b;
      ...
      rtb_Add3 = (team_project_state_and_cds_DW.clockTickCounter <
      ...
      if (team_project_state_and_cds_DW.If1_ActiveSubsystem == 0) {
         ...
         *  Product: '<S1>/Product1'
         */
        rtb_Add3 = team_project_state_and_cds_P.Constant_Value_h *
         ...
         *  Product: '<S1>/Product'
         */
        rtb_Add3 *= team_project_state_and_cds_B.drive_mode;
        if (rtsiIsModeUpdateTimeStep(&team_project_state_and_cds_M->solverInfo))
        {
          srUpdateBC
      ...
      team_project_state_and_cds_B.DiscreteTransferFcn = tmp_3;
    ...
    if (rtmIsMajorTimeStep(team_project_state_and_cds_M)) {
      ...
      switch (rtAction) {
       ...
       case 1:
        ...
        if ((uint8_T)(((uint32_T)team_project_state_and_cds_P.Gain_Gain *
          ...
          srUpdateBC(team_project_state_and_cds_DW.IfActionSubsystem_SubsysRanBC);
       ...
       */
      rtb_Gain1 = rt_roundd_snf(team_project_state_and_cds_P.Constant4_Value);
      if (rtb_Gain1 < 256.0) {
        if (rtb_Gain1 >= 0.0) {
          tmp_2 = (uint8_T)rtb_Gain1;
        } else {
...
void team_project_state_and_cds_step2(void) /* Sample time: [0.1s, 0.0s] */
{
  ...
  /* MATLABSystem: '<Root>/Digital Input' */
  team_project_state_and_cds_B.DigitalInput = readDigitalPin(36);

  /* MATLABSystem: '<Root>/Digital Input1' */
  if (team_project_state_and_cds_DW.obj_i.SampleTime !=
      team_project_state_and_cds_P.DigitalInput1_SampleTime) {
    team_project_state_and_cds_DW.obj_i.SampleTime =
      team_project_state_and_cds_P.DigitalInput1_SampleTime;
  }

  /* MATLABSystem: '<Root>/Digital Input1' */
  team_project_state_and_cds_B.DigitalInput1 = readDigitalPin(21);
...
void team_project_state_and_cds_step3(void) /* Sample time: [0.2s, 0.0s] */
{
  int8_T rtAction;

  /* Reset subsysRan breadcrumbs */
  srClearBC(team_project_state_and_cds_DW.IfActionSubsystem1_SubsysRanB_o);

  /* Reset subsysRan breadcrumbs */
  srClearBC(team_project_state_and_cds_DW.IfActionSubsystem_SubsysRanBC_i);

  /* If: '<S11>/If' */
  rtAction = -1;
  if (rtsiIsModeUpdateTimeStep(&team_project_state_and_cds_M->solverInfo)) {
    if (!team_project_state_and_cds_B.DigitalInput1) {
      rtAction = 0;
    }

    team_project_state_and_cds_DW.If_ActiveSubsystem_n = rtAction;
  } else {
    rtAction = team_project_state_and_cds_DW.If_ActiveSubsystem_n;
  }
  ...
  if (rtAction == 0) {
     ...
     *  Delay: '<S14>/Delay1'
     */
    team_project_state_and_cds_DW.Delay1_DSTATE +=
     ...
     *  Delay: '<S14>/Delay1'
     */
    team_project_state_and_cds_B.Mod1 = rt_modd_snf
      (team_project_state_and_cds_DW.Delay1_DSTATE,
       team_project_state_and_cds_P.Constant3_Value);
    if (rtsiIsModeUpdateTimeStep(&team_project_state_and_cds_M->solverInfo)) {
      srUpdateBC(team_project_state_and_cds_DW.IfActionSubsystem1_SubsysRanB_o);
    }
  ...
  /* RateTransition generated from: '<S11>/If Action Subsystem1' */
  team_project_state_and_cds_DW.TmpRTBAtIfActionSubsystem1Outpo =
    team_project_state_and_cds_B.Mod1;

  /* If: '<S6>/If' */
  rtAction = -1;
  if (rtsiIsModeUpdateTimeStep(&team_project_state_and_cds_M->solverInfo)) {
    if (!team_project_state_and_cds_B.DigitalInput) {
      rtAction = 0;
    }

    team_project_state_and_cds_DW.If_ActiveSubsystem_l = rtAction;
  } else {
    rtAction = team_project_state_and_cds_DW.If_ActiveSubsystem_l;
  }
  ...
  if (rtAction == 0) {
    ...
    team_project_state_and_cds_DW.Delay_DSTATE_j +=
      team_project_state_and_cds_P.Constant_Value_f;
    ...
    team_project_state_and_cds_B.Mod = rt_modd_snf
      (team_project_state_and_cds_DW.Delay_DSTATE_j,
       team_project_state_and_cds_P.Constant1_Value_c);

    /* Update for Delay: '<S24>/Delay' */
    team_project_state_and_cds_DW.Delay_DSTATE_j =
      team_project_state_and_cds_B.Mod;
    if (rtsiIsModeUpdateTimeStep(&team_project_state_and_cds_M->solverInfo)) {
      srUpdateBC(team_project_state_and_cds_DW.IfActionSubsystem_SubsysRanBC_i);
    }
...
void team_project_state_and_cds_initialize(void)
{
  ...
  /* External mode info */
  team_project_state_and_cds_M->Sizes.checksums[0] = (1033358742U);
  team_project_state_and_cds_M->Sizes.checksums[1] = (1555149825U);
  team_project_state_and_cds_M->Sizes.checksums[2] = (3707081118U);
  team_project_state_and_cds_M->Sizes.checksums[3] = (2282509330U);

  {
    ...
    systemRan[13] = (sysRanDType *)
      &team_project_state_and_cds_DW.IfActionSubsystem1_SubsysRanB_o;
    ...
    systemRan[20] = (sysRanDType *)
      &team_project_state_and_cds_DW.IfActionSubsystem_SubsysRanBC_i;
  ...
  team_project_state_and_cds_B.TmpRTBAtIfActionSubsystem1Outpo =
    team_project_state_and_cds_P.TmpRTBAtIfActionSubsystem1Outpo;
  ...
  /* Start for If: '<S11>/If' */
  team_project_state_and_cds_DW.If_ActiveSubsystem_n = -1;

  /* Start for If: '<S6>/If' */
  team_project_state_and_cds_DW.If_ActiveSubsystem_l = -1;
  ...
  team_project_state_and_cds_DW.Delay1_DSTATE =
    team_project_state_and_cds_P.Delay1_InitialCondition;

  /* SystemInitialize for Math: '<S14>/Mod1' incorporates:
   *  Outport: '<S14>/sw2'
   */
  team_project_state_and_cds_B.Mod1 = team_project_state_and_cds_P.sw2_Y0;
  ...
  team_project_state_and_cds_DW.Delay_DSTATE_j =
    team_project_state_and_cds_P.Delay_InitialCondition_p;

  /* SystemInitialize for Math: '<S24>/Mod' incorporates:
   *  Outport: '<S24>/Out1'
   */
  team_project_state_and_cds_B.Mod = team_project_state_and_cds_P.Out1_Y0;
  ...
  team_project_state_and_cds_DW.obj_ec.matlabCodegenIsDeleted = false;
  team_project_state_and_cds_DW.obj_ec.isInitialized = 1L;
  digitalIOSetup(13, 1);
  team_project_state_and_cds_DW.obj_ec.isSetupComplete = true;
  ...
  team_project_state_and_cds_DW.obj_i.matlabCodegenIsDeleted = false;
  team_project_state_and_cds_DW.obj_i.SampleTime =
    team_project_state_and_cds_P.DigitalInput1_SampleTime;
  team_project_state_and_cds_DW.obj_i.isInitialized = 1L;
  digitalIOSetup(21, 0);
  team_project_state_and_cds_DW.obj_i.isSetupComplete = true;
}
...
void team_project_state_and_cds_terminate(void)
{
  ...
  /* Terminate for MATLABSystem: '<S27>/PWM' */
  ...
  /* End of Terminate for MATLABSystem: '<S27>/PWM' */

  /* Terminate for MATLABSystem: '<Root>/Digital Output1' */
  if (!team_project_state_and_cds_DW.obj_ec.matlabCodegenIsDeleted) {
    team_project_state_and_cds_DW.obj_ec.matlabCodegenIsDeleted = true;
  }
  ...
  if (!team_project_state_and_cds_DW.obj_i.matlabCodegenIsDeleted) {
    team_project_state_and_cds_DW.obj_i.matlabCodegenIsDeleted = true;
  }
