...
typedef struct {
  codertarget_arduinobase_int_e_T obj; /* '<S20>/Encoder' */
  ...
  codertarget_arduinobase_blo_e_T obj_ec;/* '<Root>/Digital Output1' */
  codertarget_arduinobase_in_er_T obj_ky;/* '<S27>/PWM' */
  codertarget_arduinobase_in_er_T obj_dm;/* '<S21>/PWM' */
  ...
  int8_T IfActionSubsystem_SubsysRanBC_a;/* '<S27>/If Action Subsystem' */
...
extern void team_project_state_and_cds_step3(void);
 ...
 * '<S5>'   : 'team_project_state_and_cds/Subsystem2'
 * '<S6>'   : 'team_project_state_and_cds/light_Ctrl'
 * '<S7>'   : 'team_project_state_and_cds/LED_B Ctrl/If Action Subsystem1'
 * '<S8>'   : 'team_project_state_and_cds/LED_B Ctrl/If Action Subsystem3'
 * '<S9>'   : 'team_project_state_and_cds/LED_R Ctrl/If Action Subsystem1'
 * '<S10>'  : 'team_project_state_and_cds/LED_R Ctrl/If Action Subsystem3'
 * '<S11>'  : 'team_project_state_and_cds/State_Ctrl/ADAS_state'
 * '<S12>'  : 'team_project_state_and_cds/State_Ctrl/drive_mode'
 * '<S13>'  : 'team_project_state_and_cds/State_Ctrl/ADAS_state/If Action Subsystem'
 * '<S14>'  : 'team_project_state_and_cds/State_Ctrl/ADAS_state/If Action Subsystem1'
 * '<S15>'  : 'team_project_state_and_cds/State_Ctrl/ADAS_state/If Action Subsystem/Chart'
 * '<S16>'  : 'team_project_state_and_cds/State_Ctrl/drive_mode/Chart'
 * '<S17>'  : 'team_project_state_and_cds/State_Ctrl/drive_mode/SW1'
 * '<S18>'  : 'team_project_state_and_cds/Subsystem/Chart'
 * '<S19>'  : 'team_project_state_and_cds/Subsystem/Chart1'
 * '<S20>'  : 'team_project_state_and_cds/Subsystem2/Subsystem3'
 * '<S21>'  : 'team_project_state_and_cds/Subsystem2/Subsystem4'
 * '<S22>'  : 'team_project_state_and_cds/Subsystem2/Subsystem5'
 * '<S23>'  : 'team_project_state_and_cds/Subsystem2/Subsystem3/Discrete Derivative'
 * '<S24>'  : 'team_project_state_and_cds/light_Ctrl/If Action Subsystem'
 * '<S25>'  : 'team_project_state_and_cds/light_Ctrl/Subsystem'
 * '<S26>'  : 'team_project_state_and_cds/light_Ctrl/Subsystem/Chart1'
 * '<S27>'  : 'team_project_state_and_cds/light_Ctrl/Subsystem/Subsystem'
 * '<S28>'  : 'team_project_state_and_cds/light_Ctrl/Subsystem/Subsystem/If Action Subsystem'
 * '<S29>'  : 'team_project_state_and_cds/light_Ctrl/Subsystem/Subsystem/If Action Subsystem1'
 * '<S30>'  : 'team_project_state_and_cds/light_Ctrl/Subsystem/Subsystem/If Action Subsystem2'
 * '<S31>'  : 'team_project_state_and_cds/light_Ctrl/Subsystem/Subsystem/If Action Subsystem1/If Action Subsystem'
 * '<S32>'  : 'team_project_state_and_cds/light_Ctrl/Subsystem/Subsystem/If Action Subsystem1/If Action Subsystem1'
 */
