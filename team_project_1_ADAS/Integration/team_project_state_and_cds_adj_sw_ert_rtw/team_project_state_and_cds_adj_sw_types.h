 ...
 *
 * File: team_project_state_and_cds_adj_sw_types.h
 *
...
#ifndef RTW_HEADER_team_project_state_and_cds_adj_sw_types_h_
#define RTW_HEADER_team_project_state_and_cds_adj_sw_types_h_
#include "MW_SVD.h"
#include "rtwtypes.h"
...
#ifndef typedef_codertarget_arduinobase_blo_a_T
#define typedef_codertarget_arduinobase_blo_a_T

typedef struct tag_AYWgtFscQm3mLUJYb3A20C codertarget_arduinobase_blo_a_T;

#endif                             /* typedef_codertarget_arduinobase_blo_a_T */
...
typedef struct tag_4eDVzK5FiryyCjvjjvrZGB codertarget_arduinobase_int_a_T;
...
#ifndef typedef_codertarget_arduinobase_in_ac_T
#define typedef_codertarget_arduinobase_in_ac_T

typedef struct tag_hiATgaifu8RfrjZ2yifYbH codertarget_arduinobase_in_ac_T;

#endif                             /* typedef_codertarget_arduinobase_in_ac_T */

/* Parameters for system: '<S2>/If Action Subsystem1' */
typedef struct P_IfActionSubsystem1_team_pro_T_ P_IfActionSubsystem1_team_pro_T;

/* Parameters (default storage) */
typedef struct P_team_project_state_and_cds__T_ P_team_project_state_and_cds__T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_team_project_state_an_T RT_MODEL_team_project_state_a_T;

#endif               /* RTW_HEADER_team_project_state_and_cds_adj_sw_types_h_ */
