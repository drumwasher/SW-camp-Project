...
void rt_OneStep(void)
{
   ...
   */
  team_project_state_and_cds_adj_sw_SetEventsForThisBaseStep(eventFlags);
      ...
      switch (i)
      {
       case 2 :
        currentTime = (extmodeSimulationTime_T)
          ...
          ;
        team_project_state_and_cds_adj_sw_step2();
       ...
       case 3 :
        currentTime = (extmodeSimulationTime_T)
          ...
          ;
        team_project_state_and_cds_adj_sw_step3();
...
int main(void)
{
  ...
  team_project_state_and_cds_adj_sw_initialize();
  cli();
  sei();
  ...
  /* Terminate model */
  team_project_state_and_cds_adj_sw_terminate();
