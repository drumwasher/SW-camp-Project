...
#ifndef RTW_HEADER_dcmotor_test_types_h_
#define RTW_HEADER_dcmotor_test_types_h_
#include "MW_SVD.h"
#include "rtwtypes.h"
...
typedef struct tag_4eDVzK5FiryyCjvjjvrZGB codertarget_arduinobase_int_f_T;

#endif                             /* typedef_codertarget_arduinobase_int_f_T */

/* Parameters (default storage) */
typedef struct P_dcmotor_test_T_ P_dcmotor_test_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_dcmotor_test_T RT_MODEL_dcmotor_test_T;

#endif                                 /* RTW_HEADER_dcmotor_test_types_h_ */
