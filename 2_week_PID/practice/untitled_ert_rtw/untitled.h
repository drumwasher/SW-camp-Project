...
typedef struct {
  int64m_T Gain2;                      /* '<S1>/Gain2' */
  real_T Step;                         /* '<Root>/Step' */
  real_T DataTypeConversion1;          /* '<S1>/Data Type Conversion1' */
  real_T Add1;                         /* '<Root>/Add1' */
  real_T DataTypeConversion1_a;        /* '<S2>/Data Type Conversion1' */
...
typedef struct {
  ...
  codertarget_arduinobase_int_b_T obj_b;/* '<S2>/PWM' */
  struct {
    void *LoggedData;
 ...
 * Block '<S3>/Derivative1' : Unused code path elimination
 ...
 * '<S2>'   : 'untitled/Subsystem1'
 * '<S3>'   : 'untitled/Subsystem6'
 * '<S4>'   : 'untitled/Subsystem/Discrete Derivative'
 */
