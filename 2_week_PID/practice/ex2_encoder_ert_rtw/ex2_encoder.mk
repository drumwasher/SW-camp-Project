###########################################################################
## Makefile generated for component 'ex2_encoder'. 
## 
## Makefile     : ex2_encoder.mk
## Generated on : Fri Feb 09 21:47:43 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ex2_encoder.elf
...
PRODUCT_NAME              = ex2_encoder
MAKEFILE                  = ex2_encoder.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/tkdle/OneDrive/¹ÙÅÁÈ­~1/SW-CAM~1/TEAM_P~1/practice
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ex2_encoder.elf
...
DEFINES_STANDARD = -DMODEL=ex2_encoder -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_ArduinoEncoder.o MW_PWM.o MW_PWMDriver.o xcp_ext_mode.o ex2_encoder.o ex2_encoder_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/ex2_encoder_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


%.S.o : $(START_DIR)/ex2_encoder_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" $(subst /,\,"$<")
...
%.o : $(START_DIR)/ex2_encoder_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")
...
ert_main.o : $(START_DIR)/ex2_encoder_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


ex2_encoder.o : $(START_DIR)/ex2_encoder_ert_rtw/ex2_encoder.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


ex2_encoder_data.o : $(START_DIR)/ex2_encoder_ert_rtw/ex2_encoder_data.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


rtGetInf.o : $(START_DIR)/ex2_encoder_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


rtGetNaN.o : $(START_DIR)/ex2_encoder_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


rt_nonfinite.o : $(START_DIR)/ex2_encoder_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")
