...
#ifndef RTW_HEADER_DCmotor_Speed_Ctrl_h_
#define RTW_HEADER_DCmotor_Speed_Ctrl_h_
#ifndef DCmotor_Speed_Ctrl_COMMON_INCLUDES_
#define DCmotor_Speed_Ctrl_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* DCmotor_Speed_Ctrl_COMMON_INCLUDES_ */

#include "DCmotor_Speed_Ctrl_types.h"
...
} X_DCmotor_Speed_Ctrl_T;

/* State derivatives (default storage) */
typedef struct {
  real_T TransferFcn1_CSTATE;          /* '<Root>/Transfer Fcn1' */
} XDot_DCmotor_Speed_Ctrl_T;

/* State disabled  */
typedef struct {
  boolean_T TransferFcn1_CSTATE;       /* '<Root>/Transfer Fcn1' */
} XDis_DCmotor_Speed_Ctrl_T;
...
struct P_DCmotor_Speed_Ctrl_T_ {
...
struct tag_RTM_DCmotor_Speed_Ctrl_T {
  const char_T *errorStatus;
  RTWExtModeInfo *extModeInfo;
  RTWSolverInfo solverInfo;
  X_DCmotor_Speed_Ctrl_T *contStates;
  int_T *periodicContStateIndices;
  real_T *periodicContStateRanges;
  real_T *derivs;
  XDis_DCmotor_Speed_Ctrl_T *contStateDisabled;
...
extern P_DCmotor_Speed_Ctrl_T DCmotor_Speed_Ctrl_P;

/* Block signals (default storage) */
extern B_DCmotor_Speed_Ctrl_T DCmotor_Speed_Ctrl_B;

/* Continuous states (default storage) */
extern X_DCmotor_Speed_Ctrl_T DCmotor_Speed_Ctrl_X;

/* Disabled states (default storage) */
extern XDis_DCmotor_Speed_Ctrl_T DCmotor_Speed_Ctrl_XDis;

/* Block states (default storage) */
extern DW_DCmotor_Speed_Ctrl_T DCmotor_Speed_Ctrl_DW;

/* Model entry point functions */
extern void DCmotor_Speed_Ctrl_initialize(void);
extern void DCmotor_Speed_Ctrl_step(void);
extern void DCmotor_Speed_Ctrl_terminate(void);

/* Real-time Model object */
extern RT_MODEL_DCmotor_Speed_Ctrl_T *const DCmotor_Speed_Ctrl_M;
